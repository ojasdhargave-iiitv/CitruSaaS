...
const IconLogo = () => (
  <img src="/logo.png" alt="CitruSaaS Logo" style={{ height: '32px', objectFit: 'contain',filter: 'invert(1)' }} />
);
  ...
  return (
    <div className="sidebar-container">
      <div className="sidebar-header">
        ...
        <Link to="/profile" className={`nav-item ${location.pathname === '/profile' ? 'active' : ''}`} style={{ textDecoration: 'none', color: 'inherit' }}>
